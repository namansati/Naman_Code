...
def topology():
    ...
    RSU1 = net.addAccessPoint ('RSU1', ssid='SSID_ap1', dpid='1', cls=OVSKernelAP,  mac="00:00:00:00:00:70", mode='g', failMode='standalone', range= '100', channel=4, position='150,105,0', datapath='user') # cls=OVSKernelAP, inNamespace=False,
    RSU2 = net.addAccessPoint ('RSU2', ssid='SSID_ap2', dpid='2', color='r', cls=OVSKernelAP, mac="00:00:00:00:00:80", mode='g', failMode='standalone', range= '100', channel=4, position='330,105,0', datapath='user')
                                                                                                                                                            #30                                     #100,105,0
    ...
    net.mobility (sta1, 'start', time=5, position="10,105,0") # 150,105,0
    net.mobility (sta1, 'stop', time=90, position="500,105,0") # 150,105,0
    
    net.mobility (sta2, 'start', time=5, position="10,105,0") # 150,105,0
    net.mobility (sta2, 'stop', time=90, position="500,105,0") # 10,105,0

    net.mobility (sta3, 'start', time=15, position="10,105,0") # 150,105,0
    net.mobility (sta3, 'stop', time=100, position="500,105,0") # 10,105,0

    net.mobility (sta4, 'start', time=5, position="10,105,0") # 150,105,0
    net.mobility (sta4, 'stop', time=90, position="500,105,0") # 10,105,0
    
    net.mobility (sta5, 'start', time=9, position="10,105,0") # 150,105,0
    net.mobility (sta5, 'stop', time=94, position="500,105,0")

    net.mobility (sta6, 'start', time=5, position="10,105,0") # 150,105,0
    net.mobility (sta6, 'stop', time=90, position="500,105,0") # 10,105,0
    
    net.mobility (sta7, 'start', time=9, position="10,105,0") # 150,105,0
    net.mobility (sta7, 'stop', time=94, position="500,105,0")

    net.mobility (sta9, 'start', time=5, position="10,105,0") # 150,105,0
    net.mobility (sta9, 'stop', time=90, position="500,105,0") # 10,105,0
    
    net.mobility (sta8, 'start', time=9, position="10,105,0") # 150,105,0
    net.mobility (sta8, 'stop', time=94, position="500,105,0")

    net.mobility (sta10, 'start', time=5, position="10,105,0") # 150,105,0
    net.mobility (sta10, 'stop', time=90, position="500,105,0") # 10,105,0
    
    '''
    net.mobility (sta11, 'start', time=5, position="10,105,0") # 150,105,0
    net.mobility (sta11, 'stop', time=90, position="500,105,0") # 10,105,0

    net.mobility (sta12, 'start', time=5, position="10,105,0") # 150,105,0
    net.mobility (sta12, 'stop', time=90, position="500,105,0") # 10,105,0

    net.mobility (sta13, 'start', time=5, position="10,105,0") # 150,105,0
    net.mobility (sta13, 'stop', time=90, position="500,105,0") # 10,105,0
    
    net.mobility (sta14, 'start', time=5, position="10,105,0") # 150,105,0
    net.mobility (sta14, 'stop', time=90, position="500,105,0") # 10,105,0

    net.mobility (sta15, 'start', time=5, position="10,105,0") # 150,105,0
    net.mobility (sta15, 'stop', time=90, position="500,105,0") # 10,105,0    
    
    net.mobility (sta16, 'start', time=5, position="10,105,0") # 150,105,0
    net.mobility (sta16, 'stop', time=90, position="500,105,0") # 10,105,0    
    
    net.mobility (sta17, 'start', time=5, position="10,105,0") # 150,105,0
    net.mobility (sta17, 'stop', time=90, position="500,105,0") # 10,105,0    
    
    net.mobility (sta18, 'start', time=5, position="10,105,0") # 150,105,0
    net.mobility (sta18, 'stop', time=90, position="500,105,0") # 10,105,0    

    net.mobility (sta19, 'start', time=5, position="10,105,0") # 150,105,0
    net.mobility (sta19, 'stop', time=90, position="500,105,0") # 10,105,0
    
    net.mobility (sta20, 'start', time=5, position="10,105,0") # 150,105,0
    net.mobility (sta20, 'stop', time=90, position="500,105,0") # 10,105,0
    '''
    ...
    makeTerm (RSU1, cmd = "bash -c 'python3 Naman_RSU1_topo.py;'")     #Naman_RSU1_topo.py
    #time.sleep(1)
    makeTerm (RSU2, cmd = "bash -c 'python3 Naman_RSU2_Topo.py ;'")   #Naman_RSU2_Topo.py
    #makeTerm(RSU1)
    time.sleep(1)
    '''
