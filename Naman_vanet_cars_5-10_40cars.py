...
def topology():
    ...
    net.mobility (sta1, 'stop', time=78, position="640,105,0") # 150,105,0
    
    net.mobility (sta2, 'start', time=9, position="120,105,0") # 150,105,0
    net.mobility (sta2, 'stop', time=78, position="640,105,0") # 10,105,0

    net.mobility (sta3, 'start', time=15, position="120,105,0") # 150,105,0
    net.mobility (sta3, 'stop', time=84, position="640,105,0") # 10,105,0

    net.mobility (sta4, 'start', time=9, position="120,105,0") # 150,105,0
    net.mobility (sta4, 'stop', time=78, position="640,105,0") # 120,105,0
    
    net.mobility (sta5, 'start', time=9, position="120,105,0") # 150,105,0
    net.mobility (sta5, 'stop', time=78, position="640,105,0")
    
    net.mobility (sta6, 'start', time=9, position="120,105,0") # 150,105,0
    net.mobility (sta6, 'stop', time=78, position="640,105,0") # 120,105,0
    
    net.mobility (sta7, 'start', time=9, position="120,105,0") # 150,105,0
    net.mobility (sta7, 'stop', time=78, position="640,105,0")

    net.mobility (sta9, 'start', time=9, position="120,105,0") # 150,105,0
    net.mobility (sta9, 'stop', time=78, position="640,105,0") # 120,105,0
    
    net.mobility (sta8, 'start', time=9, position="120,105,0") # 150,105,0
    net.mobility (sta8, 'stop', time=78, position="640,105,0")
    
    net.mobility (sta10, 'start', time=9, position="120,105,0") # 150,105,0
    net.mobility (sta10, 'stop', time=78, position="640,105,0") # 120,105,0

    net.mobility (sta11, 'start', time=9, position="120,105,0") # 150,105,0
    net.mobility (sta11, 'stop', time=78, position="640,105,0") # 120,105,0

    net.mobility (sta12, 'start', time=9, position="120,105,0") # 150,105,0
    net.mobility (sta12, 'stop', time=78, position="640,105,0") # 120,105,0

    net.mobility (sta13, 'start', time=9, position="120,105,0") # 150,105,0
    net.mobility (sta13, 'stop', time=78, position="640,105,0") # 120,105,0
    
    net.mobility (sta14, 'start', time=9, position="120,105,0") # 150,105,0
    net.mobility (sta14, 'stop', time=78, position="640,105,0") # 120,105,0

    net.mobility (sta15, 'start', time=9, position="120,105,0") # 150,105,0
    net.mobility (sta15, 'stop', time=78, position="640,105,0") # 120,105,0    
    
    net.mobility (sta16, 'start', time=9, position="120,105,0") # 150,105,0
    net.mobility (sta16, 'stop', time=78, position="640,105,0") # 120,105,0    
    
    net.mobility (sta17, 'start', time=9, position="120,105,0") # 150,105,0
    net.mobility (sta17, 'stop', time=78, position="640,105,0") # 120,105,0    
    
    net.mobility (sta18, 'start', time=9, position="120,105,0") # 150,105,0
    net.mobility (sta18, 'stop', time=78, position="640,105,0") # 120,105,0    

    net.mobility (sta19, 'start', time=9, position="120,105,0") # 150,105,0
    net.mobility (sta19, 'stop', time=78, position="640,105,0") # 120,105,0
    
    net.mobility (sta20, 'start', time=9, position="120,105,0") # 150,105,0
    net.mobility (sta20, 'stop', time=78, position="640,105,0") # 120,105,0
    
    #net.mobility (sta10, 'start', time=9, position="120,105,0") # 150,105,0
    #net.mobility (sta10, 'stop', time=78, position="640,105,0") # 120,105,0

    net.mobility (sta21, 'start', time=9, position="120,105,0") # 150,105,0
    net.mobility (sta21, 'stop', time=78, position="640,105,0") # 120,105,0

    net.mobility (sta22, 'start', time=9, position="120,105,0") # 150,105,0
    net.mobility (sta22, 'stop', time=78, position="640,105,0") # 120,105,0

    net.mobility (sta23, 'start', time=9, position="120,105,0") # 150,105,0
    net.mobility (sta23, 'stop', time=78, position="640,105,0") # 120,105,0
    
    net.mobility (sta24, 'start', time=9, position="120,105,0") # 150,105,0
    net.mobility (sta24, 'stop', time=78, position="640,105,0") # 120,105,0

    net.mobility (sta25, 'start', time=9, position="120,105,0") # 150,105,0
    net.mobility (sta25, 'stop', time=78, position="640,105,0") # 120,105,0    
    
    net.mobility (sta26, 'start', time=9, position="120,105,0") # 150,105,0
    net.mobility (sta26, 'stop', time=78, position="640,105,0") # 120,105,0    
    
    net.mobility (sta27, 'start', time=9, position="120,105,0") # 150,105,0
    net.mobility (sta27, 'stop', time=78, position="640,105,0") # 120,105,0    
    
    net.mobility (sta28, 'start', time=9, position="120,105,0") # 150,105,0
    net.mobility (sta28, 'stop', time=78, position="640,105,0") # 120,105,0    

    net.mobility (sta29, 'start', time=9, position="120,105,0") # 150,105,0
    net.mobility (sta29, 'stop', time=78, position="640,105,0") # 120,105,0
    
    net.mobility (sta30, 'start', time=9, position="120,105,0") # 150,105,0
    net.mobility (sta30, 'stop', time=78, position="640,105,0") # 120,105,0
